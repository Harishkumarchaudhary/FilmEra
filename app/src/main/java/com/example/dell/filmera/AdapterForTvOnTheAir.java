...
public class AdapterForTvOnTheAir extends RecyclerView.Adapter<AdapterForTvOnTheAir.UserHolder> {
    ArrayList<ApiClassForTvOnTheAir.Data> arrayList;
    Context context;
    AdapterForTvOnTheAir(Context context,ArrayList<ApiClassForTvOnTheAir.Data> arrayList){
        this.context=context;
        this.arrayList=arrayList;
    }
    @NonNull
    @Override
    public AdapterForTvOnTheAir.UserHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater= (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        View view=layoutInflater.inflate(R.layout.layout_of_popular,parent,false);
        return new AdapterForTvOnTheAir.UserHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final AdapterForTvOnTheAir.UserHolder holder, final int position) {
