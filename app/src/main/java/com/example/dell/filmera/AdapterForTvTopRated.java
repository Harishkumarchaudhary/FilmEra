...
public class AdapterForTvTopRated extends RecyclerView.Adapter<AdapterForTvTopRated.UserHolder> {
        ArrayList<ApiClassForTvTopRated.Data> arrayList;
        Context context;
        AdapterForTvTopRated(Context context,ArrayList<ApiClassForTvTopRated.Data> arrayList){
            this.context=context;
            this.arrayList=arrayList;
        }
        @NonNull
        @Override
        public AdapterForTvTopRated.UserHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            LayoutInflater layoutInflater= (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            View view=layoutInflater.inflate(R.layout.layout_of_popular,parent,false);
            return new AdapterForTvTopRated.UserHolder(view);
        }

        @Override
        public void onBindViewHolder(@NonNull final AdapterForTvTopRated.UserHolder holder, final int position) {
